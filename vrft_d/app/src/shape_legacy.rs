...
/// Returns all parameter names used by legacy functions
pub fn get_all_parameter_names() -> &'static [&'static str] {
    &[
        // From get_v1_parameters
        "JawX",
        "JawOpen",
        "MouthUpper",
        "MouthLower",
        ...
        "MouthTightener",
        "NoseSneer",
        // From get_v1_sranipal_lip_parameters
        "JawRight",
        "JawLeft",
        "JawForward",
        "MouthApeShape",
